...
@Component({
  selector: 'app-interested-sheet-form',
  templateUrl: './interested-sheet-form.component.html',
  styleUrls: ['./interested-sheet-form.component.scss']
})
export class InterestedSheetFormComponent {
   ...
   constructor(
     ...
     private _dialogRef: MatDialogRef<InterestedSheetFormComponent>,
